...
test('@end-2-end Place an order for sigle product from prodcuct catalgo page', async ({ page }) => {
    ...
    await test.step('Navigate to Sauce Demo application', async () => {
    ...
    await test.step('Verify order confirmation page elements', async () => {
...
test('@end-2-end Place an order for all product from prodcuct catalgo page', async ({ page }) => {
    ...
    await test.step('Validate item subtotal amount on order review page', async () => {
