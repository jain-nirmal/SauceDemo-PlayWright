...
test.describe('@ CartPage Cart Page Tests', () => 
  ...
  test.only('@CartPage @Sanity Validate product title ,Continue , Remove , Url on cart page', async ({ page }) =>    {
  ...
  test.only('@CartPag @Sanity Add  product to cart and verify in cart page', async ({ page }) => 
    {
    ...
    test.only('@CartPag @Sanity Validate Continue shopping move to productpage', async ({ page }) => 
    {
    ...
    test.only('@CartPag @Sanity Validate Remove product from cart', async ({ page }) => 
    {
